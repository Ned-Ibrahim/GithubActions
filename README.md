[![Run App Ibrahim, Mohannad](https://github.com/Ned-Ibrahim/GithubActions/actions/workflows/run-app.yml/badge.svg)](https://github.com/Ned-Ibrahim/GithubActions/actions/workflows/run-app.yml)
